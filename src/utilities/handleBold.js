function handleBoldClick(editorContent, editorRef, setEditorContent) {
    ...
    if (selectedText.startsWith("**") && selectedText.endsWith("**")) {
        const unboldText = selectedText.substring(2, selectedText.length - 2);
