function handleBlockQuote(editorContent, editorRef, setEditorContent) {
    ...
    if (selectedText.startsWith(">")) {
        const unheadingText = selectedText.substring(1, selectedText.length);
